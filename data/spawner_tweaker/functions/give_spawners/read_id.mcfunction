...
$data modify storage spawner_tweaker:temp give.name set string storage spawner_tweaker:temp Ids[{id:$(id)}].name
execute unless data storage spawner_tweaker:temp give{name:""} run scoreboard players set name temp 2
