#20hz on an the player holding a spawner

#Mark the player
tag @s add holding_spawner

#Grab data version
execute store result score version temp run data get entity @s DataVersion
...
execute at @s anchored eyes run function spawner_tweaker:spawner_tweaking/player/raycast_1.20.5
