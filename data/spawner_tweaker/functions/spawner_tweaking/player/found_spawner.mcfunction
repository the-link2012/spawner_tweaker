...
execute if entity 38e349da-d05c-47c9-85c5-dad3300233dc if score swap_spawner spawner_tweaker matches 22.. run function spawner_tweaker:spawner_tweaking/player/select_spawner

#If no spawner is selected
execute unless entity 38e349da-d05c-47c9-85c5-dad3300233dc run function spawner_tweaker:spawner_tweaking/player/select_spawner
