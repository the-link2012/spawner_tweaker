...
execute if score $data_population spawner_tweaker matches 1 run data modify block ~ ~ ~ SpawnData set from storage spawner_tweaker:temp update_to.SpawnPotentials[0].data
