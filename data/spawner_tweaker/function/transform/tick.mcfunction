...
#End when needed
execute if score spawners_transformed st_priming >= total_spawners st_priming run function spawner_tweaker:transform/end
...
execute if score transform_timer st_priming >= max temp run function spawner_tweaker:transform/end