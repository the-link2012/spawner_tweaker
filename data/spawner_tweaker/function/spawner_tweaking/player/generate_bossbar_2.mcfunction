...
$bossbar add spawner_tweaker_$(tweaker_id) [{"color":"white","text":""},{"color":"gray","text":"["},{"color":"gray","text":"ID:"},{"color":"gold","text":"$(id)"},{"color":"gray","text":"] - "},{"text":"$(name)"},{"color":"gray","text":" - $(spawners) spawners"}]
