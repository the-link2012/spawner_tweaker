...
execute if score swap_spawner spawner_tweaker matches 22.. if entity @s[predicate=!spawner_tweaker:shifting] align xyz positioned ~0.5 ~0.5 ~0.5 run function spawner_tweaker:spawner_tweaking/player/select_spawner with storage spawner_tweaker:temp variables
