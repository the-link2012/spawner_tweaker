...
#Failsafe teleports
execute as 4a3f09af-b376-485e-a73a-a4566af88748 run tp @s ~ ~ ~ 0 0

execute as 6bfec13b-598f-4bae-a827-47d28c4ed07f run tp @s ~ ~ ~ 45 0
execute as da2312b0-3f93-4a23-924e-6e3c44671606 run tp @s ~ ~ ~ 90 0
execute as d50c642b-1f61-4279-ac82-b466969b76b2 run tp @s ~ ~ ~ 135 0
execute as 44e9d1cf-3203-443e-951d-93bc841abf3f run tp @s ~ ~ ~ 0 0
execute as 2ebaaca0-b021-44a3-b0ee-e757109f6f28 run tp @s ~ ~ ~ 0 -90

execute as aec389bc-e396-41ac-8bef-85ebcf593123 run tp @s ~ ~ ~ 180 0
execute as cc96b0f1-bdd5-498c-9e6d-64daba58daa8 run tp @s ~ ~ ~ -90 0
execute as 4ca433fe-64bf-404d-bc76-e09f9f719902 run tp @s ~ ~ ~ -45 0
execute as d364a92f-4534-48b0-bf64-6da74289be62 run tp @s ~ ~ ~ -135 0
execute as e18bf975-d677-435c-9542-d3b0ec6685c5 run tp @s ~ ~ ~ 0 90