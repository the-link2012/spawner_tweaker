...
execute store result storage spawner_tweaker:temp temp.x float 0.000195 run scoreboard players get temp temp
...
execute as @e[distance=..0.1,tag=st_radius] run data merge entity @s {text:'{"text":"⭕","color":"red","italic":false}',text_opacity:100}
execute if entity @s[tag=st_player_near] as @e[distance=..0.1,tag=st_radius] run data merge entity @s {text:'{"text":"⭕","color":"dark_green","italic":false}',text_opacity:60}
