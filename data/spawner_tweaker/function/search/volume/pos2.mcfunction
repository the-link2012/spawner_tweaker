...
#Tell ouput
execute unless score $pos1_set st_volume matches 1.. run tellraw @s {"color":"yellow","text":"Position 2 set"}
execute if score $pos1_set st_volume matches 1.. run function spawner_tweaker:search/volume/pos2_tell with storage spawner_tweaker:temp variables
