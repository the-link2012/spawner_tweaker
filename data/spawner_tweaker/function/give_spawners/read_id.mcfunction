...
execute store result score damage temp run data get storage spawner_tweaker:temp give.spawner.SpawnPotentials[0].data.entity.attributes[{id:"minecraft:generic.attack_damage"}].base 100
execute if data storage spawner_tweaker:temp give.spawner.SpawnPotentials[0].data.entity.attributes[{id:"minecraft:generic.attack_damage"}].base store result storage spawner_tweaker:temp give.Attack double 0.01 run scoreboard players get damage temp
data modify storage spawner_tweaker:temp give.Speed set from storage spawner_tweaker:temp give.spawner.SpawnPotentials[0].data.entity.attributes.[{id:"minecraft:generic.movement_speed"}].base
execute if data storage spawner_tweaker:temp give.spawner.SpawnPotentials[0].data.entity.attributes.[{id:"minecraft:generic.movement_speed"}] run data modify storage spawner_tweaker:temp give.Speed_desc set value " 🏃 "
data modify storage spawner_tweaker:temp give.Size set from storage spawner_tweaker:temp give.spawner.SpawnPotentials[0].data.entity.attributes.[{id:"minecraft:generic.scale"}].base
execute if data storage spawner_tweaker:temp give.spawner.SpawnPotentials[0].data.entity.attributes.[{id:"minecraft:generic.scale"}] run data modify storage spawner_tweaker:temp give.Size_desc set value " ✥ "
data modify storage spawner_tweaker:temp give.Armor set from storage spawner_tweaker:temp give.spawner.SpawnPotentials[0].data.entity.attributes.[{id:"minecraft:generic.armor"}].base
execute if data storage spawner_tweaker:temp give.spawner.SpawnPotentials[0].data.entity.attributes.[{id:"minecraft:generic.armor"}] run data modify storage spawner_tweaker:temp give.Armor_desc set value " ⛨ "
