...
execute if score name temp matches 2 run data modify storage spawner_tweaker:temp give.name set from storage spawner_tweaker:temp give.spawner.components."minecraft:custom_name"
