...
**NOTE:** If your map was 1.21.4 and used Spawner Tweaker, you will need to re-register spawners or update most ids due to nbt changes. Use these commands to reset the data storage for re-registering:<br>
